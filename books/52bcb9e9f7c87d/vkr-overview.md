...
VKRはVulkanのリアルタイムでレイトレーシングをする拡張で、[2020年12月](https://www.khronos.org/blog/vulkan-ray-tracing-final-specification-release)にSDKが配布されたようです。
...
ちなみにAny-Hit Shaderはこの文章では実装しません。
