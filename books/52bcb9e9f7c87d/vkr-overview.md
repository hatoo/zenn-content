...
:::message
VKRのチュートリアルをネットで探すと`VK_NV_ray_tracing`とNvidia独自の拡張を使ったものが見つかるかもしれません。これは古いAPIなので避けたほうが良いかしれません。
といっても現在標準のKHR拡張とそこまで大きな違いがあるわけではありません。
:::

単にGPUでレイトレーシングしたいならVKR拡張がなくてもできます([筆者が作った例(Compute Shaderを使っている)](https://github.com/hatoo/rukako))。CPUよりはだいぶ速いです。
...
[画像リンク](https://www.amd.com/system/files/2020-10/579976-hardware-accelerated-raytracing-1920x500.jpg)
